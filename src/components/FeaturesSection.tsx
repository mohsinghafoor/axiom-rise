...
export default function FeaturesSection() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "15+ years of industry experience with skilled artisans and modern production facilities equipped with cutting-edge technology for precision manufacturing.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
