        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              >
                <span className="sr-only">{t('footerLinkedIn')}</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">{t('footerContactInfo')}</h4>
            <div className="space-y-2 text-gray-600 dark:text-gray-300">
              <p>{t('footerAddress1')}</p>
              <p>{t('footerAddress2')}</p>
              <p>{t('footerCountry')}</p>
              <p className="font-medium text-gray-900 dark:text-white">{t('footerPhone')}</p>
              <p className="font-medium text-gray-900 dark:text-white">{t('footerEmail')}</p>
            </div>
          </div>
        </div>
