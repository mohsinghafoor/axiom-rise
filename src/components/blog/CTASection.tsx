      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-2xl mx-auto mb-8">
            <input 
              ...
              className="flex-1 px-6 py-3 rounded-lg border-2 border-gray-300 focus:border-primary-600 focus:outline-none text-gray-900"
            />
            <button className="bg-primary-600 hover:bg-primary-700 text-white px-8 py-3 rounded-lg font-semibold transition-all hover:scale-105 shadow-lg whitespace-nowrap">
              Subscribe Now
            </button>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-300">
          ...
          <div className="flex justify-center gap-4">
            <Link href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-primary-600 hover:text-white transition-all">
